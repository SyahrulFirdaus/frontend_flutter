                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: const Icon(Icons.place, color: Colors.orange),
                    ),
                    validator: (value) {
                        ...
                        child: GoogleMap(
                          ...
                          markers: {
                            Marker(
                              ...
                              infoWindow: InfoWindow(title: namaLokasiC.text),
                            ),
                          },
                      ...
                      Expanded(
                        child: Obx(() {
                          ...
                          return ElevatedButton(
                                ...
                                : () async {
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      await controller.updatePusatLokasi(
                                        id: item.id,
                                        namaLokasi:
                                            namaLokasiC.text != item.namaLokasi
                            ...
                            child: Text(isLoading ? 'Menyimpan...' : 'Update'),
                          );
                        }),
                      ),
                    ],
