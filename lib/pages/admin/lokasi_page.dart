// // lib/pages/admin/lokasi_page.dart
...
//   // Controller untuk single entry
//   final TextEditingController lokasiC = TextEditingController();
//   final TextEditingController koordinatC = TextEditingController();
...
//           bottom: const TabBar(
//             tabs: [
//               Tab(icon: Icon(Icons.add_location), text: 'Single Entry'),
//               Tab(icon: Icon(Icons.library_add), text: 'Multiple Entry'),
//             ],
//           ),
//           actions: [
//             IconButton(
...
//             children: [
//               // Tab Single Entry
//               _buildSingleEntryTab(),
//               // Tab Multiple Entry
//               _buildMultipleEntryTab(),
//             ],
//           );
//         }),
//       ),
...
//             _buildUserDropdown(selectedUserId),
//             const SizedBox(height: 16),
...
//                   borderRadius: BorderRadius.circular(8),
//                 ),
//                 hintText: 'Contoh: Ruang 101, Gedung A',
...
//             TextField(
//               controller: koordinatC,
//               decoration: InputDecoration(
//                 labelText: 'Koordinat',
//                 border: OutlineInputBorder(
//                   borderRadius: BorderRadius.circular(8),
//                 ),
//                 hintText: 'Contoh: -6.123, 106.123',
...
//   Widget _buildUserDropdown(RxString selectedValue) {
//     return Obx(() {
//       if (controller.users.isEmpty) {
//         return Container(
//           padding: const EdgeInsets.all(12),
...
//     controller.addLokasi(
//       userId: selectedUserId.value,
//       lokasi: lokasiC.text,
//       koordinat: koordinatC.text,
//     );
...
class LokasiPage extends GetView<LokasiController> {
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              onChanged: (value) {
                // Update map jika koordinat sudah ada
                if (koordinatC.text.isNotEmpty) {
                  _parseAndShowMap(koordinatC.text);
                }
              },
            ),
            const SizedBox(height: 16),
                      ...
                      markers: {
                        Marker(
                          ...
                          infoWindow: InfoWindow(
                            title: lokasiC.text.isEmpty
                                ? 'Lokasi'
                                : lokasiC.text,
                            snippet: koordinatC.text,
                          ),
                        ),
                      },
  ...
  void _parseAndShowMap(String koordinatText) {
    try {
      final parts = koordinatText.split(',');
      if (parts.length == 2) {
        final lat = double.tryParse(parts[0].trim());
        final lng = double.tryParse(parts[1].trim());
        if (lat != null && lng != null) {
          selectedLocation.value = LatLng(lat, lng);
          // Update camera position jika map sudah siap
